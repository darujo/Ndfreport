...
public class PayConverter {
    ...
    public static Pay getPay(PayDTO pay){
        // todo тестовый режим
        return new Pay(pay.getId(), pay.getMerchantLogin(), pay.getInvId(), pay.getOutSum(), pay.getDescription(), pay.getSignatureValue(), pay.getEmail(),pay.getIsTest() == null || pay.getIsTest()== 1, pay.getIsCompleted() != null && pay.getIsCompleted());
    }
}
