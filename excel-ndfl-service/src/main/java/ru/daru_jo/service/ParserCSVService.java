...
public class ParserCSVService {
    ...
    @Transactional
    public void readDataLineByLine(Order order, String file) {
        try {
            FileReader filereader = new FileReader(file);
            readDataLineByLine(order, filereader);
    ...
    @Transactional
    public void readDataLineByLine(Order order, Reader reader) {
...
// TODO Правильное русское название в двух местах
     ...
     *               0        ,1     ,2       ,3   ,4          ,5
     */
    private void saveDividend(Order order, String[] record) {
        Dividend dividend = new Dividend(
                null,
                getCodeDividend(record[4]),
                Timestamp.valueOf(record[3] + " 00:00:00" ),
     ...
     *               0              ,1     ,2       ,3   ,4          ,5     ,6
     */
    private void saveDividendTax(Order order, String[] record) {
